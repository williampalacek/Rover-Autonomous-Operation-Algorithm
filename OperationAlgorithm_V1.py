...
turn_gain = 1.5  # Gain for turning speed adjustment
forward_gain = 0.05  # Gain for forward speed adjustment
angular_linear_weight = 1.8  # Weight for balancing angular and linear movements
min_fwd_vel = 0.4  # Minimum forward velocity
max_fwd_vel = 2.0  # Maximum forward velocity
x_goal = 20  # X-coordinate of the goal
y_goal = 9  # Y-coordinate of the goal
k = 75  # Constant for potential field calculation
sqr_error = 0.1  # Square of the acceptable error margin to the goal
